...
|---|------|---------|--------|--------|
| 1 | Revert to 30% connectivity | ~3x (free) | Already decided | Pending |
| 2 | Sparse eligibility updates | ~5x on medium path | ~200 lines | Pending |
| 3 | Rayon Tier 1 (drop-in par_iter swaps) | ~2x on glacial/slow paths | ~30 min | Pending |
| 4 | Rayon Tier 2 #6 (three-factor learning) | Biggest single-loop impact | Read-write phase separation | Pending |
...
## Rayon Tier 1: Drop-in `par_iter` Swaps
...
## Rayon Tier 2: Topology-Bound Parallelization
