...
\begin{enumerate}
  ...
  \item Experimental validation on CartPole (solved), MNIST (30\% intact, 48\% post-damage on v3.0.0), and a 4-tier NLP readiness benchmark (Section~\ref{sec:experiments}).
