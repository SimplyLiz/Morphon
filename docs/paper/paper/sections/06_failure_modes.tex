...
Dopaminergic excitotoxicity \cite{wakade1985dopamine}. Biology prevents this through receptor desensitization on sustained exposure, presynaptic autoreceptor inhibition, and synaptic reuptake.
...
The pattern is monotonic in plasticity \emph{within the oscillating regime}: more plasticity, more accuracy. But pure constant high plasticity (1.80) also fails (25\%) because the weights churn without ever consolidating. The system needs both phases.
