...
Endoquilibrium is the homeostatic regulator. It monitors seven vital signs (firing rates by cell type, eligibility density, weight entropy, energy utilization, prediction error mean, reward EMA), maintains dual-timescale exponential moving averages (fast $\tau=50$, slow $\tau=500$), and adjusts seven modulation channels through proportional control: receptor gains $\rho_R, \rho_N, \rho_A, \rho_H$ for reward/novelty/arousal/homeostasis, threshold bias, plasticity multiplier, and consolidation gain.
