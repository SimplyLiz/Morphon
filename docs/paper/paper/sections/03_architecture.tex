...
This section presents the six biological principles underlying MI and the data structures that implement them. Each subsection maps a biological concept to a precise computational mechanism.
