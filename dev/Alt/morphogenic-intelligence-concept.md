...
### 4.2 AI-gestütztes Meta-Learning

Ein existierender LLM (oder ein anderes trainiertes System) kann als "Lehrer" fungieren — nicht durch direkten Wissenstransfer, sondern als Umgebung, die:

- Sinnvolle Stimuli generiert (Trainingspatterns)
- Reward-Signale liefert (der dritte Faktor)
- Die Entwicklungsregeln selbst durch evolutionäre Optimierung verbessert

Das ist "AI-enabled" im tiefsten Sinne: Die neue Architektur wird durch die alte in die Existenz begleitet.
